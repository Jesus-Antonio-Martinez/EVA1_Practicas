...
CREATE TABLE `carrera` (
  `no_Carrera` int(11) NOT NULL AUTO_INCREMENT,
  `creditos` int(11) DEFAULT NULL,
  `area` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`no_Carrera`)
...
INSERT INTO `productos` VALUES (1,'Manzana',15),(2,'Peras',20),(3,'Cocos',30),(4,'Platano',30);
...
-- Dump completed on 2018-09-23 22:38:29
